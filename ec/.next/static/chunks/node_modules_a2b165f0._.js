...
class ClientError extends Error {
    static extractMessage(response) {
        var _response_errors_, _response_errors;
        var _response_errors__message;
        return (_response_errors__message = (_response_errors = response.errors) === null || _response_errors === void 0 ? void 0 : (_response_errors_ = _response_errors[0]) === null || _response_errors_ === void 0 ? void 0 : _response_errors_.message) !== null && _response_errors__message !== void 0 ? _response_errors__message : "GraphQL Error (Code: ".concat(String(response.status), ")");
    }
    constructor(response, request){
        const message = "".concat(ClientError.extractMessage(response), ": ").concat(JSON.stringify({
            response,
            request
        }));
        super(message), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "response", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "request", void 0);
...
const casesExhausted = (value)=>{
    throw new Error("Unhandled case: ".concat(String(value)));
};
...
function assertArray(v) {
    if (!Array.isArray(v)) throw new Error("Expected array. Got: ".concat(String(v)));
}
function assertObject(v) {
    if (v === null || typeof v !== "object") throw new Error("Expected object. Got: ".concat(String(v)));
}
...
const createDeferred = (options)=>{
    ...
    return {
        ...
        resolve: (value)=>{
            isResolved = true;
            if ((options === null || options === void 0 ? void 0 : options.strict) && isResolved) {
                throw new Error("Deferred is already resolved. Attempted to resolve with: ".concat(JSON.stringify(value)));
            }
            resolve(value);
        },
...
const parseRawRequestExtendedArgs = function(urlOrOptions, query) {
 ...
 */ const extractOperationName = (document)=>{
    ...
    if (defs.length === 1) {
        var _defs__name;
        operationName = (_defs__name = defs[0].name) === null || _defs__name === void 0 ? void 0 : _defs__name.value;
    }
...
const analyzeDocument = (document, excludeOperationName)=>{
    const expression = typeof document === "string" ? document : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$graphql$2f$language$2f$printer$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["print"])(document);
    let isMutation = false;
    let operationName = undefined;
    ...
    const docNode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$graphql$2d$request$2f$build$2f$lib$2f$prelude$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tryCatch"])(()=>typeof document === "string" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$graphql$2f$language$2f$parser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parse"])(document) : document);
...
const runRequest = async (input)=>{
    var _input_method, _input_method1, _input_fetchOptions_errorPolicy;
    // todo make a Config type
    const config = {
        ...input,
        method: input.request._tag === "Single" ? input.request.document.isMutation ? "POST" : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$graphql$2d$request$2f$build$2f$lib$2f$prelude$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uppercase"])((_input_method = input.method) !== null && _input_method !== void 0 ? _input_method : "post") : input.request.hasMutations ? "POST" : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$graphql$2d$request$2f$build$2f$lib$2f$prelude$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uppercase"])((_input_method1 = input.method) !== null && _input_method1 !== void 0 ? _input_method1 : "post"),
        fetchOptions: {
            ...input.fetchOptions,
            errorPolicy: (_input_fetchOptions_errorPolicy = input.fetchOptions.errorPolicy) !== null && _input_fetchOptions_errorPolicy !== void 0 ? _input_fetchOptions_errorPolicy : "none"
        }
    };
    ...
    var _input_fetchOptions_jsonSerializer;
    const result = await parseResultFromResponse(fetchResponse, (_input_fetchOptions_jsonSerializer = input.fetchOptions.jsonSerializer) !== null && _input_fetchOptions_jsonSerializer !== void 0 ? _input_fetchOptions_jsonSerializer : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$graphql$2d$request$2f$build$2f$legacy$2f$helpers$2f$defaultJsonSerializer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultJsonSerializer"]);
...
const parseResultFromResponse = async (response, jsonSerializer)=>{
    const contentType = response.headers.get(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$graphql$2d$request$2f$build$2f$lib$2f$http$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CONTENT_TYPE_HEADER"]);
...
const createFetcher = (method)=>async (params)=>{
        ...
        if (method === "POST") {
            var _params_fetchOptions_jsonSerializer;
            const $jsonSerializer = (_params_fetchOptions_jsonSerializer = params.fetchOptions.jsonSerializer) !== null && _params_fetchOptions_jsonSerializer !== void 0 ? _params_fetchOptions_jsonSerializer : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$graphql$2d$request$2f$build$2f$legacy$2f$helpers$2f$defaultJsonSerializer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultJsonSerializer"];
        ...
        var _params_fetch;
        const $fetch = (_params_fetch = params.fetch) !== null && _params_fetch !== void 0 ? _params_fetch : fetch;
...
const buildBody = (params)=>{
    switch(params.request._tag){
        ...
        case "Batch":
            var _params_request_variables;
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$graphql$2d$request$2f$build$2f$lib$2f$prelude$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["zip"])(params.request.query, (_params_request_variables = params.request.variables) !== null && _params_request_variables !== void 0 ? _params_request_variables : []).map((param)=>{
...
const buildQueryParams = (params)=>{
    ...
    switch(params.request._tag){
        ...
        case "Batch":
            {
                var _params_request_variables;
                var _params_request_variables_map;
                const variablesSerialized = (_params_request_variables_map = (_params_request_variables = params.request.variables) === null || _params_request_variables === void 0 ? void 0 : _params_request_variables.map((v)=>$jsonSerializer.stringify(v))) !== null && _params_request_variables_map !== void 0 ? _params_request_variables_map : [];
                ...
                const payload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$graphql$2d$request$2f$build$2f$lib$2f$prelude$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["zip"])(queriesCleaned, variablesSerialized).map((param)=>{
                    let [query, variables] = param;
                    return {
                        query,
                        variables
...
class GraphQLClient {
    async request(documentOrOptions) {
        for(var _len = arguments.length, variablesAndRequestHeaders = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++){
            variablesAndRequestHeaders[_key - 1] = arguments[_key];
        }
        const [variables, requestHeaders] = variablesAndRequestHeaders;
    ...
    async batchRequests(documentsOrOptions, requestHeaders) {
        ...
        const analyzedDocuments = batchRequestOptions.documents.map((param)=>{
            let { document } = param;
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$graphql$2d$request$2f$build$2f$legacy$2f$helpers$2f$analyzeDocument$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["analyzeDocument"])(document, excludeOperationName);
        });
        const expressions = analyzedDocuments.map((param)=>{
            let { expression } = param;
            return expression;
        });
        const hasMutations = analyzedDocuments.some((param)=>{
            let { isMutation } = param;
            return isMutation;
        });
        const variables = batchRequestOptions.documents.map((param)=>{
            let { variables } = param;
            return variables;
        });
        var _this_requestConfig_fetch;
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$graphql$2d$request$2f$build$2f$legacy$2f$helpers$2f$runRequest$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["runRequest"])({
            url: this.url,
            request: {
                _tag: "Batch",
            ...
            fetch: (_this_requestConfig_fetch = this.requestConfig.fetch) !== null && _this_requestConfig_fetch !== void 0 ? _this_requestConfig_fetch : globalThis.fetch,
    ...
    constructor(url, requestConfig = {}){
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "requestConfig", void 0);
        /**
     * Send a GraphQL query to the server.
     */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "rawRequest", async function() {
            for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
                args[_key] = arguments[_key];
            }
            ...
            const { headers, fetch = globalThis.fetch, method = "POST", requestMiddleware, responseMiddleware, excludeOperationName, ...fetchOptions } = _this.requestConfig;
            const { url } = _this;
...
const parseRequestExtendedArgs = function(urlOrOptions, document) {
    for(var _len = arguments.length, variablesAndRequestHeaders = new Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++){
        variablesAndRequestHeaders[_key - 2] = arguments[_key];
    }
    const [variables, requestHeaders] = variablesAndRequestHeaders;
...
const gql = function(chunks) {
    ...
    return chunks.reduce((acc, chunk, index)=>"".concat(acc).concat(chunk).concat(index in variables ? String(variables[index]) : ""), "");
...
"[project]/node_modules/graphql-request/build/entrypoints/main.js [app-client] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/rehackt/index.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=node_modules_a2b165f0._.js.map